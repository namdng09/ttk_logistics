...
import 'package:ttk_logistics/app_constant.dart';
import 'package:ttk_logistics/controller/ui/components/forms/form_wizard_controller.dart';
...
class _FormWizardScreenState extends State<FormWizardScreen> with UIMixin {
  ...
  List<Widget> getContents() {
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: InkWell(
                  ...
                  child: Icon(controller.showPassword ? RemixIcons.eye_line : RemixIcons.eye_off_line, size: 18),
                ),
                contentPadding: MySpacing.all(16),
                isCollapsed: true,
                floatingLabelBehavior: FloatingLabelBehavior.never,
          ...
          children: [
            ...
            MyButton.outlined(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: <Widget>[
                  Icon(RemixIcons.calendar_check_line, color: theme.colorScheme.primary, size: 16),
                  MySpacing.width(10),
                  MyText.labelMedium(
    ...
    step3() {
      return Column(
        children: [
          Icon(RemixIcons.checkbox_circle_line, size: 44, color: contentTheme.primary),
          MySpacing.height(32),
