...
import 'package:ttk_logistics/controller/ui/components/forms/basic_element_controller.dart';
...
class _BasicElementScreenState extends State<BasicElementScreen> with UIMixin {
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // First RadioGroup for custom radio toggles
                RadioGroup<int>(
                ...
                RadioGroup<int>(
                  ...
                  onChanged: controller.onSelectInlineRadio,
                  child: Wrap(
                    children: [
                      Row(
                        mainAxisSize: MainAxisSize.min,
                ...
                RadioGroup<int>(
                  ...
                  onChanged: (int? value) {
                    controller.selectedDisableRadioValue = value!;
                  },
                  child: Wrap(
                    children: [
                      Row(
                ...
                RadioGroup<int>(
                  ...
                  onChanged: controller.onSelectColorRadio,
                  child: Column(
                    children: [
  ...
  Widget buildRadio(int value, String label, Color color) {
    return RadioGroup<int>(
      ...
      onChanged: (newValue) {
        if (newValue != null) {
          controller.onSelectColorRadio(newValue);
        }
      },
      child: Row(
        children: [
  ...
  Widget formRow() {
    return MyCard(
      ...
      child: Column(
        ...
        children: [
          MyContainer(
              width: double.infinity, borderRadiusAll: 0,
