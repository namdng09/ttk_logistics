  ...
  Widget defaultSlider() {
    return MyCard(
      ...
      child: Column(
        ...
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Default", fontWeight: 700, muted: true)),
          Padding(
  ...
  Widget minAndMixSlider() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Min-Max Slider", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget prefixSlider() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Prefix Slider", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget rangeSlider() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Range", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget stepRange() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Step", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget customValues() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Custom Values", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget stepSlider() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Step Slider", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: SfSliderTheme(
              data: SfSliderThemeData(),
  ...
  Widget labelSlider() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Label Slider", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: SfSliderTheme(
              data: SfSliderThemeData(),
  ...
  Widget tickSlider() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Tick Slider", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: SfSliderTheme(
              data: SfSliderThemeData(),
  ...
  Widget dividerSlider() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Divider Slider", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: SfSliderTheme(
              data: SfSliderThemeData(),
  ...
  Widget yearSlider() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Year Slider", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: SfSliderTheme(
              data: SfSliderThemeData(),
  ...
  Widget hourSlider() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Hour Slider", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: SfSliderTheme(
              data: SfSliderThemeData(),
