...
import 'package:ttk_logistics/controller/ui/components/base_ui/list_group_controller.dart';
  ...
  Widget basicExample() {
    return MyCard(
      ...
      child: Column(
        ...
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Basic Example", fontWeight: 700, muted: true)),
  ...
  Widget activeItems() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Active Items", fontWeight: 700, muted: true)),
  ...
  Widget disableItems() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Disable Items", fontWeight: 700, muted: true)),
  ...
  Widget flush() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Flush", fontWeight: 700, muted: true)),
  ...
  Widget horizontal() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Horizontal", fontWeight: 700, muted: true)),
  ...
  Widget withBadge() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("With badges", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: MyContainer.bordered(
              paddingAll: 0,
  ...
  Widget numbered() {
    ...
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Numbered", fontWeight: 700, muted: true)),
