...
import 'package:ttk_logistics/controller/ui/components/base_ui/utilities_controller.dart';
  ...
  Widget textColor() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Text Color", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Row(
              children: [
  ...
  Widget opacity() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Opacity", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Wrap(
              spacing: 20,
  ...
  Widget borderColor() {
    ...
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Border Color", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
  ...
  Widget containerBorderRadius() {
    ...
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Border Radius", fontWeight: 700, muted: true)),
          MySpacing.height(20),
          Padding(
            padding: MySpacing.all(24),
            child: Wrap(spacing: 20, runSpacing: 20, children: [for (var radius in borderRadius) buildAvatar(Images.users[1], radius)]),
          ),
        ],
      ),
    );
  ...
  Widget overflow() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Overflow", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Wrap(
              spacing: 20,
  ...
  Widget shadow() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Shadow", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget objectFit() {
    ...
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Object fit", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Wrap(
              spacing: 20,
