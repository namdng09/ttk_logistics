...
import 'package:ttk_logistics/controller/ui/components/base_ui/typography_controller.dart';
  ...
  Widget headings() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Headings", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget unordered() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Unordered", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                UnorderedList(
                  items: [
                    ...
                    UnorderedList(
                      items: ['Phasellus iaculis neque', 'Vestibulum laoreet porttitor sem', 'Ac tristique libero volutpat at'],
                    ),
  ...
  Widget ordered() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Ordered", fontWeight: 700, muted: true)),
  ...
  Widget unStyled() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.bodyMedium("Unstyled", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget blockQuotes() {
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Blockquotes", fontWeight: 700, muted: true)),
          Padding(
            padding: MySpacing.all(24),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      flex: 3,
                      child: MyText.bodyMedium('Truncated term is truncated', fontWeight: 600, overflow: TextOverflow.ellipsis),
                    ),
                    Expanded(
                      flex: 9,
                      child: MyText.bodyMedium(
