...
import 'package:ttk_logistics/controller/ui/components/base_ui/notifications_controller.dart';
  ...
  Widget basic() {
   ...
   shadow: MyShadow(elevation: 1, position: MyShadowPosition.bottom),
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyContainer(width: double.infinity, borderRadiusAll: 0, child: MyText.titleMedium("Basic", fontWeight: 700, muted: true)),
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Image.asset(Images.logoSm, height: 20),
                            MySpacing.width(12),
