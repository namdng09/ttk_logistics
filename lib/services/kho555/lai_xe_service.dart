...
class LaiXeService {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (items != null) {
          final list = items
              .whereType<Map>()
              .map((e) => LaiXe.fromJson(Map<String, dynamic>.from(e)))
              .toList();
          return {'items': list, 'pagination': pagination};
        }

        throw Exception('Không tìm thấy dữ liệu lái xe');
      }
  ...
  static Future<ApiResponse> saveLaiXe(Map<String, dynamic> data) async {
    return _request(
      ...
      method: 'POST',
      data: data,
      fallbackMessage: 'Không thể lưu lái xe',
    );
  }

  static Future<ApiResponse> updateLaiXe(
    int nid,
    ...
    return _request(
      ...
      method: 'PUT',
      data: data,
      fallbackMessage: 'Không thể cập nhật lái xe',
    );
  }
  ...
  static List<dynamic> _decodeContentList(dynamic content) {
    ...
    throw Exception('Dữ liệu lái xe không hợp lệ từ Worker');
  }
