...
class DialogThuTienCongNo extends StatelessWidget {
  DialogThuTienCongNo({super.key});
                ...
                children: [
                      ...
                      children: [
                        ...
                        DataTable(
                          ...
                          columns: const [
                            ...
                            DataColumn(label: Text("Số tiền thanh toán")),
                  ...
                  if (controller.hinhThucThanhToan == HinhThucThanhToan.theoTongTien)
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Khách thanh toán", style: TextStyle(fontWeight: FontWeight.w600)),
                        const SizedBox(height: 6),
                        TextFormField(
        ...
        ElevatedButton.icon(
          ...
          onPressed: controller.isLoadingThuTien
            ...
            if (controller.tongTienKhachThanhToan <= 0) {
              AppToast.error("Vui lòng nhập số tiền khách thanh toán");
              return;
            }
