    ...
    <div class="modal-dialog modal-fullscreen" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <div>
            <h5 class="modal-title mb-1">Tạo kế hoạch hàng cảng</h5>
            <div class="text-muted small">Nhập thông tin chuyến xe, container và tuyến vận chuyển</div>
          </div>
        ...
        <div class="modal-body position-relative">
          ...
          <form id="ke-hoach-form" novalidate>
            ...
            <div class="text-center py-3">
              <button type="button" class="btn btn-label-primary" id="add-line-btn"><i class="ti tabler-plus me-1"></i>Tạo kế hoạch</button>
            </div>
          </form>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal">Đóng</button>
          <button type="button" class="btn btn-primary" id="save-btn"><i class="icon-base ti tabler-device-floppy me-1"></i>Lưu</button>
        </div>
      </div>
    </div>
  </div>
