<div class="card">
    <div class="card-header row">
        ...
        <div class="col-md-4 text-end">
            <div>
                <a href="#" class="btn btn-success btn-them-danh-muc" data-bs-toggle="modal"
                   data-bs-target="<?= strpos(current_path(), 'danh-muc/nha-xe') !== FALSE ? '#them-nha-xe-modal' : '#them-danh-muc-modal'; ?>">
